...
### Recipe detail page
* Detail content - A selected recipes' details are displayed. Authenticated users can rate other user's recipes, and the averaged rating score will be displayed. When I was working on this page, I didn't know how to use CBV with POST request, so build with FBV. This comment section doesn't need approval.
...
![ Create recipe form page ](readme-img/feat-recipe-add.png " Create recipe form page ")  
...
### Posts detail page
Post detail content - A selected post details are displayed. Authenticated users can comment on any posts and no approval needed. 
* Post detail page  
![ Post detail page ](readme-img/feat-posts-detail.png " Post detail page")  

### Posts CRUD pages

* Create post form page - This Post form looks all the fields are required. But if user didn't choose any images automatically selected default image in the Cloudiary. 
...
* Message - I add the setting that Django's message tag fits the Bootstrap's colour scheme  
...
The hierarchy is in this order:　Home - Recipes > Latest Posts > Single post page > Edit/Delete 　
The recipe's app doesn't have it's own list page as the Home (Top) page is working as a recipe's list page.

## FUTURE FEATURES

I stopped development at this point because the website already achieved my ideal minimum viable product(MVP). Any open issues can be tracked [here](https://github.com/users/AtsukoCoffey/projects/6). These are the "Won't Have" for this project that will not be included in this projct submission. These may be revisited and added in the future. 
<a id="tech"></a>
...
* Django Recipe Sharing Tutorial - Dee Mc  
This is my mentor Gareth Mc Girr's wife's Youtube walkthrough. I didn't have time to study "Part 2 Meal planner" but "Part 1 Recipe sharing" was exactly what I needed to see from the setting to create views and templates. This is fantastic learning material. I'll try this "Part 2" walkthrough soon.   
[Django Recipe Sharing Tutorial - Dee Mc](https://www.youtube.com/watch?v=sBjbty691eI&list=PLXuTq6OsqZjbCSfiLNb2f1FOs8viArjWy "Django Recipe Sharing Tutorial - Dee Mc")
...
How to set the star rating system - however this tip is using JavaScript and create own API using urls, didn't work for me. Mainly used this tip for css layout purpose.
...
* I picked up some example posts and comments from like these website.  
[https://www.reddit.com/](https://www.reddit.com/ "https://www.reddit.com/")



### CREDITS - Imagery
All the free images that I borrowed from Pexels.com  
* Egg picture - Pexels - Antoni Shkraba [https://www.pexels.com/photo/spiced-soft-boiled-egg-on-marble-tabletop-4397266/](https://www.pexels.com/photo/spiced-soft-boiled-egg-on-marble-tabletop-4397266/ "https://www.pexels.com/photo/spiced-soft-boiled-egg-on-marble-tabletop-4397266/")
* Lady looking at ingredients - 
Photo by Kampus Production: [https://www.pexels.com/photo/a-woman-deciding-on-what-to-buy-8422719/](https://www.pexels.com/photo/a-woman-deciding-on-what-to-buy-8422719/ "https://www.pexels.com/photo/a-woman-deciding-on-what-to-buy-8422719/")
...
### Other student's recipe projects
...
### Other student's agile for reference  

* Aneta's Glimmer Kanban Board • PP4 - Aneta's Glimmer (github.com)    
[Aneta's Glimmer Kanban Board • PP4 - Aneta's Glimmer (github.com)](https://github.com/users/tomik-z-cech/projects/1/views/1 "Aneta's Glimmer Kanban Board • PP4 - Aneta's Glimmer (github.com)")

* @tomdu3's Books for Life - P4      
[@tomdu3's Books for Life - P4](https://github.com/users/tomdu3/projects/4 "@tomdu3's Books for Life - P4")
